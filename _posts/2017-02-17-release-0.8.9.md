...
Today, version `0.8.9`, the "Patched Beta" release of our {{ site.projectNameStyled }} software suite, was published. Compared to the <a href="{{ site.baseurl }}/page/2016/07/17/release-0.8.7.html">previous release</a>, this new version comes much closer to our goal to reduce the workload of researchers and practitioners during the development of algorithms to allow them to spend more time on thinking.
